...
CREATE TABLE MISSION_PARTICIPATION (
	...
	review VARCHAR(500),
	payment_status VARCHAR(20) DEFAULT 'UNPAID' CHECK (payment_status IN ('UNPAID', 'PAID', 'LIQUIDATED', 'REFUNDED')),
	mission_payment_pid INT,
	FOREIGN KEY (mid) REFERENCES MISSION(mid),
	FOREIGN KEY (adventurer_id) REFERENCES APP_USER(uid),
	FOREIGN KEY (mission_payment_pid) REFERENCES MISSION_PAYMENT(pid)
);

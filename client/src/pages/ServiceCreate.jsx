...
export const NewMission = () => {
  ...
  return (
    <>
      <title>{`Service creation | Hermyx`}</title>
      <meta
        name='description'
        content={`Form to create and publish a service into Hermyx.`}
      ></meta>
  ...
  return (
    <div className='flex flex-col w-full max-w-4xl gap-4'>
      ...
      >
        ...
        >
          ...
          <div className='min-w-0'>
            <CardForm.Title className={'min-w-0'}>
              {messages.NEW_SERVICE.FORM_TITLE}
            </CardForm.Title>
            <CardForm.Description className={'ms-0.5'}>
              {messages.NEW_SERVICE.FORM_DESCRIPTION}
        ...
        <CardForm.Content
          legend='Application new service form.'
          className={'-mb-2'}
        >
          <FormInputField
            id='newMissionTitle'
          ...
          <FormTextareaField
            ...
            description={messages.NEW_SERVICE.DESCRIPTION_DESCRIPTION}
            error={
        ...
        <div className='px-8 py-2'>
          <Map
            ...
            description={messages.NEW_SERVICE.LOCATION_DESCRIPTION}
          ></Map>
          {(state.errors?.latitude || state.errors?.longitude) &&
            !isAlertClosed && (
              <FormAlert onClose={() => setIsAlertClosed(true)}>
                {messages.NEW_SERVICE.LOCATION_ERROR}
              </FormAlert>
            )}
        </div>
        <CardForm.Footer>
